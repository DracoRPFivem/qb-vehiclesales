...
Config.Zones = {
    ...
    ["ottosoccasions"] = {
        BusinessName = "Vehicle Sales Contract - Otto's Auto Vehicle Sales",
        SellVehicle = vector4(802.53, -821.07, 26.18, 77.74),
        BuyVehicle = vector4(817.35, -808.52, 26.19, 5.82),

        PolyZone = {
            vector2(811.51251220704, -817.83569335938),
            vector2(811.40692138672, -823.8998413086),
            vector2(793.73760986328, -823.78601074218),
            vector2(793.86022949218, -802.22344970704),
            vector2(811.80780029296, -802.7318725586)
        },
        MinZ = 24.0,
        MaxZ = 28.0,

        VehicleSpots = {
            vector4(798.4, -805.24, 26.27, 101.42),
            vector4(798.0, -808.37, 26.26, 91.01),
            vector4(798.06, -811.75, 26.18, 87.62),
            vector4(797.94, -814.78, 26.18, 89.8),
            vector4(797.71, -818.27, 26.18, 91.3),
            vector4(809.34, -814.87, 26.19, 89.02),
            vector4(809.08, -811.92, 26.18, 100.45),
            vector4(808.67, -808.97, 26.22, 92.84),
            vector4(808.44, -805.88, 26.23, 100.37),
        }
    },
}    
